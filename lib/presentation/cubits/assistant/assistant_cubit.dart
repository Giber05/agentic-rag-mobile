...
class AssistantCubit extends Cubit<AssistantState> {
  ...
  AssistantCubit({
    ...
    required SearchKnowledgeUsecase searchKnowledgeUsecase,
    required GetSuggestionsUsecase getSuggestionsUsecase,
    required CheckHealthUsecase checkHealthUsecase,
    required Logger logger,
  }) : _askQuestionUsecase = askQuestionUsecase,
       _searchKnowledgeUsecase = searchKnowledgeUsecase,
